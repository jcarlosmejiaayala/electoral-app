(function () {
    ...
    function controller($state, usuario, estados, SweetAlert) {
        var scope = this;
        this.data = {};
        this.data.telefonos = {};
    ...
    angular
        .module('electoralApp')
        .controller('configCandidatoNuevoController', controller);

    controller.$inject = ['$state', 'usuario', 'estados', 'SweetAlert'];
})();